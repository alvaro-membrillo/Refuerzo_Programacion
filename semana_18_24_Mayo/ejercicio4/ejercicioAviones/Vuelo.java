...
public class Vuelo {
    ...
    /*Atributos*/
    private Avion[] aviones; //Instanciamos un objeto de la clase Avion
    ...
    public Vuelo(/*Avion[] aviones, */String fecha, String aeropuertoOrigen, String aeropuertoDestino) { //Lista de parámetros que le pasamos
